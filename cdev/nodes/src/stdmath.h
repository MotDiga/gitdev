...
real64_t strtoreal(string_t strnum); //!!! more accurate, e = 2.71828, pi...
...
// string_t uinttostr(uint64_t _int);
...
//? zeta64, eta64, psi64 => alif64 (d(gamma(x))/dx), beta64, harmonic64, li64 (log integral), ei64 (exp integral), ci64 (cos integral), si64 (sin integral)...
//? erf64 (error function), cerf (complementary error function cerf(x) = 1 - erf(x))...
//? chebychev polynomials, 
//? calulate somme constats: pi, e, gamma (elar-masheroni)...
...
//! ****************************************************************************************************************************************************************
//! * Node structure to simplify algebra, calculate derivative and entiderivative (integral)...
//! ? derivative using epsilon numbers, asymptotic approctimations of integrals...
