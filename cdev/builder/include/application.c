...
//* avx
    ...
    vec_4 fv4_1 = { 1.0f, 2.0f, 3.0f, 4.0f }, fv4_2 = { 0.0f, -5.0f, 1.0f, 9.0f };

    mat_4 mat4fv = { fv4_1, fv4_2, fv4_1+fv4_2, fv4_1-fv4_2 };

    log_colorgreen("%10f %10f %10f %10f\n", mat4fv[0][0], mat4fv[0][1], mat4fv[0][2], mat4fv[0][3]);
    log_colorgreen("%10f %10f %10f %10f\n", mat4fv[1][0], mat4fv[1][1], mat4fv[1][2], mat4fv[1][3]);
    log_colorgreen("%10f %10f %10f %10f\n", mat4fv[2][0], mat4fv[2][1], mat4fv[2][2], mat4fv[2][3]);
    log_colorgreen("%10f %10f %10f %10f\n", mat4fv[3][0], mat4fv[3][1], mat4fv[3][2], mat4fv[3][3]);
