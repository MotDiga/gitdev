...
#define RSA_FAST_ENC_KEY (rsakey_t){ 95889085, 18581125, 110240129 }
#define RSA_FAST_DEC_KEY (rsakey_t){ 18581125, 95889085, 110240129 }


//****************************************************************************************************************************************************************
//* RSA
uint32_t   rsa_find_c_m_dlist(const uint64_t m_c, const uint64_t e_d, const uint64_t n);           //! Slow
uint32_t   rsa_find_c_m_memoryhungry(const uint64_t m_c, const uint64_t e_d, const uint64_t n);    //! Faster but...
uint32_t   rsa_find_c_m(const uint64_t m_c, const uint64_t e_d, const uint64_t n);
#define    RSA_FIND_CM(m_c, e_d, n) rsa_find_c_m_memoryhungry(m_c, e_d, n)
