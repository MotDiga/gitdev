...
#define RENDERER_FPS_60      1
#define RENDERER_FPS_30      2
#define RENDERER_SCREEN_MAX  1
#define RENDERER_SCREEN_FULL 2

#define RENDERER_OBJECT_2DCOLOR   0
#define RENDERER_OBJECT_2DTEXTURE 1

#define RENDERER_CAMERA_2DMVP 0
...
//? mat4_t*  camera_transform(camera_t, void (*transform)(...), ...)
...
void     renderer_updatecamera(renderer_t *renderer, mat4_t model, void (*transform_updateparameters)());
...
void     renderer_ebodrawelement(renderer_t *renderer, uint32_t ebt);
